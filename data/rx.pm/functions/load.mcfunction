...
execute if score rx.PlayerDB load matches 1.. if data storage rx:info playerdb.version if score $major rx.temp matches 1 if score $minor rx.temp matches 0.. run scoreboard players set rx.PlayerMatch load 1
